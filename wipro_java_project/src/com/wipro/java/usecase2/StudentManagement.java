...
public class StudentManagement 
{
	public static void main(String[] args) 
	{
		...
		while(true)
		{
			System.out.println("_____Student Management System_____");
			System.out.println();
			...
			int choice = sc.nextInt();
			 ...
			 switch (choice) {
             case 1:
                 System.out.println("___Add Student Details___");
             ...
             case 3:
            	 System.out.println();
                 System.out.println("_Displaying all students___");
             ...
             case 10:
                 System.out.println("___Exiting the application. Thank you!___");
                 sc.close();
                 return;

             default:
                 System.out.println("___Invalid choice! Please try again.____");
         }
